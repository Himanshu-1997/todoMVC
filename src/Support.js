    ...
    return (
        <div className='sp-wrapper'>
            ...
            <div className='sp-body'>
                <div className='sp-listitem'><div className='sp-listitemnum'>1.</div><div><li>Double click on any list item to edit it.</li></div></div>
                ...
                <div className='sp-listitem'><div className='sp-listitemnum'>3.</div><div><li>List item can be deleted by clicking on the cross button of on the right of Todo.</li></div></div>
